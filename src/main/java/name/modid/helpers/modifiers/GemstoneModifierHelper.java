...
public class GemstoneModifierHelper {
  ...
  private static final Class<?>[] MAINHAND_ITEMS = {
      SwordItem.class, AxeItem.class, PickaxeItem.class, ShovelItem.class, BowItem.class, CrossbowItem.class
  };
  ...
  public static AttributeModifierSlot getAttributeModifierSlot(Item item) {
    ...
    if (item instanceof ArmorItem armorItem) {
      return switch (armorItem.getComponents().get(DataComponentTypes.EQUIPPABLE).slot()) {
